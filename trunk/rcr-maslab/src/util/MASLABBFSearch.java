...
public final class MASLABBFSearch {
    ...
    */
    ...
    /**
       ...
       @param Bloqueios Os bloqueios conhecidos durante o trajeto
       @param goals The set of possible goals.
       @return The path from start to one of the goals, or null if no path can be found.
    */
    public List<EntityID> breadthFirstSearch(EntityID start, List<EntityID> Bloqueios, EntityID... goals) {
    ...
    /**
       ...
       @return The path from start to one of the goals, or null if no path can be found.
    */
    public List<EntityID> breadthFirstSearch(EntityID start, List<EntityID> Bloqueios, Collection<EntityID> goals) {
